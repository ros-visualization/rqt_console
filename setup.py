...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/resource/icons/rqt_icons/actions/22',
            ['resource/icons/rqt_icons/actions/22/dialog-error.png',
             'resource/icons/rqt_icons/actions/22/dialog-information.png',
             'resource/icons/rqt_icons/actions/22/dialog-warning.png',
             'resource/icons/rqt_icons/actions/22/document-open.png',
             'resource/icons/rqt_icons/actions/22/document-save.png',
             'resource/icons/rqt_icons/actions/22/edit-clear.png',
             'resource/icons/rqt_icons/actions/22/format-text-strikethrough.png',
             'resource/icons/rqt_icons/actions/22/list-add.png',
             'resource/icons/rqt_icons/actions/22/list-remove.png',
             'resource/icons/rqt_icons/actions/22/media-playback-pause.png',
             ]),
